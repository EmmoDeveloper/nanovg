...
// Test: nvgFontSize with parameters: {'size': 36.0}

int main(void)
{
	printf("=== Testing nvgFontSize variant 3 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgFontSize Test");
	...
	nvgText(vg, 10, 20, "nvgFontSize - variant 3", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_fontsize_003.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgFontSize variant 3\n");
	return 0;
}
