...
// Test: nvgReset with parameters: {}

int main(void)
{
	printf("=== Testing nvgReset variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgReset Test");
	...
	nvgText(vg, 10, 20, "nvgReset - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_reset_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgReset variant 0\n");
	return 0;
}
