...
// Test: nvgFontSize with parameters: {'size': 24.0}

int main(void)
{
	printf("=== Testing nvgFontSize variant 2 ===\n");
	...
	nvgText(vg, 10, 20, "nvgFontSize - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_fontsize_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgFontSize variant 2\n");
	return 0;
}
