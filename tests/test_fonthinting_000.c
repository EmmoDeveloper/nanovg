...
// Test: nvgFontHinting with parameters: {'hinting': 'NVG_HINTING_NONE'}

int main(void)
{
	printf("=== Testing nvgFontHinting variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgFontHinting - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_fonthinting_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgFontHinting variant 0\n");
	return 0;
}
