...
// Test: nvgFontBlur with parameters: {'blur': 0.0}

int main(void)
{
	printf("=== Testing nvgFontBlur variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgFontBlur - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_fontblur_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgFontBlur variant 0\n");
	return 0;
}
