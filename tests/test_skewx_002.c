...
// Test: nvgSkewX with parameters: {'angle': 0.5}

int main(void)
{
	printf("=== Testing nvgSkewX variant 2 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgSkewX Test");
	...
	nvgText(vg, 10, 20, "nvgSkewX - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_skewx_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgSkewX variant 2\n");
	return 0;
}
