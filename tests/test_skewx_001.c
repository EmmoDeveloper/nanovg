...
// Test: nvgSkewX with parameters: {'angle': 0.1}

int main(void)
{
	printf("=== Testing nvgSkewX variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgSkewX - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_skewx_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgSkewX variant 1\n");
	return 0;
}
