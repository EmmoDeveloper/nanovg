...
// Test: nvgSubpixelText with parameters: {'enabled': 1}

int main(void)
{
	printf("=== Testing nvgSubpixelText variant 1 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgSubpixelText Test");
	...
	nvgText(vg, 10, 20, "nvgSubpixelText - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_subpixeltext_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgSubpixelText variant 1\n");
	return 0;
}
