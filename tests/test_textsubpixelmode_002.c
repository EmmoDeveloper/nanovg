...
// Test: nvgTextSubpixelMode with parameters: {'mode': 2}

int main(void)
{
	printf("=== Testing nvgTextSubpixelMode variant 2 ===\n");
	...
	nvgText(vg, 10, 20, "nvgTextSubpixelMode - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_textsubpixelmode_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTextSubpixelMode variant 2\n");
	return 0;
}
