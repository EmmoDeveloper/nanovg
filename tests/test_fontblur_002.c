...
// Test: nvgFontBlur with parameters: {'blur': 2.0}

int main(void)
{
	printf("=== Testing nvgFontBlur variant 2 ===\n");
	...
	nvgText(vg, 10, 20, "nvgFontBlur - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_fontblur_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgFontBlur variant 2\n");
	return 0;
}
