...
// Test: nvgLineJoin with parameters: {'join': 'NVG_ROUND'}

int main(void)
{
	printf("=== Testing nvgLineJoin variant 1 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgLineJoin Test");
	...
	nvgText(vg, 10, 20, "nvgLineJoin - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_linejoin_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgLineJoin variant 1\n");
	return 0;
}
