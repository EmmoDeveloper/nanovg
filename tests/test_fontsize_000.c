...
// Test: nvgFontSize with parameters: {'size': 12.0}

int main(void)
{
	printf("=== Testing nvgFontSize variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgFontSize - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_fontsize_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgFontSize variant 0\n");
	return 0;
}
