...
// Test: nvgStrokeWidth with parameters: {'size': 10.0}

int main(void)
{
	printf("=== Testing nvgStrokeWidth variant 3 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgStrokeWidth Test");
	...
	nvgText(vg, 10, 20, "nvgStrokeWidth - variant 3", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_strokewidth_003.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgStrokeWidth variant 3\n");
	return 0;
}
