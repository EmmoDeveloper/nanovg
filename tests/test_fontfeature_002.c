...
// Test: nvgFontFeature with parameters: {'tag': 'NVG_FEATURE_ZERO', 'enabled': 0}

int main(void)
{
	printf("=== Testing nvgFontFeature variant 2 ===\n");
	...
	nvgText(vg, 10, 20, "nvgFontFeature - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_fontfeature_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgFontFeature variant 2\n");
	return 0;
}
