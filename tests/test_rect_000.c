...
// Test: nvgRect with parameters: {'x': 10, 'y': 10, 'w': 100, 'h': 50}

int main(void)
{
	printf("=== Testing nvgRect variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgRect - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_rect_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgRect variant 0\n");
	return 0;
}
