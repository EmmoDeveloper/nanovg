...
// Test: nvgRotate with parameters: {'angle': 0.785}

int main(void)
{
	printf("=== Testing nvgRotate variant 1 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgRotate Test");
	...
	nvgText(vg, 10, 20, "nvgRotate - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_rotate_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgRotate variant 1\n");
	return 0;
}
