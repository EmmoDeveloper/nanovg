...
// Test: nvgMiterLimit with parameters: {'limit': 10.0}

int main(void)
{
	printf("=== Testing nvgMiterLimit variant 1 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgMiterLimit Test");
	...
	nvgText(vg, 10, 20, "nvgMiterLimit - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_miterlimit_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgMiterLimit variant 1\n");
	return 0;
}
