...
// Test: nvgMoveTo with parameters: {'x': 100, 'y': 100}

int main(void)
{
	printf("=== Testing nvgMoveTo variant 1 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgMoveTo Test");
	...
	nvgText(vg, 10, 20, "nvgMoveTo - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_moveto_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgMoveTo variant 1\n");
	return 0;
}
