...
// Test: nvgSubpixelText with parameters: {'enabled': 0}

int main(void)
{
	printf("=== Testing nvgSubpixelText variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgSubpixelText - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_subpixeltext_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgSubpixelText variant 0\n");
	return 0;
}
