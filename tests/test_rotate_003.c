...
// Test: nvgRotate with parameters: {'angle': 3.14}

int main(void)
{
	printf("=== Testing nvgRotate variant 3 ===\n");
	...
	nvgText(vg, 10, 20, "nvgRotate - variant 3", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_rotate_003.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgRotate variant 3\n");
	return 0;
}
