...
// Test: nvgScale with parameters: {'x': 2.0, 'y': 2.0}

int main(void)
{
	printf("=== Testing nvgScale variant 2 ===\n");
	...
	nvgText(vg, 10, 20, "nvgScale - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_scale_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgScale variant 2\n");
	return 0;
}
