...
// Test: nvgLineTo with parameters: {'x': 100, 'y': 10}

int main(void)
{
	printf("=== Testing nvgLineTo variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgLineTo - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_lineto_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgLineTo variant 0\n");
	return 0;
}
