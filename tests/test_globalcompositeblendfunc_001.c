...
// Test: nvgGlobalCompositeBlendFunc with parameters: {'sfactor': 'NVG_SRC_ALPHA', 'dfactor': 'NVG_ONE_MINUS_SRC_ALPHA'}

int main(void)
{
	printf("=== Testing nvgGlobalCompositeBlendFunc variant 1 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgGlobalCompositeBlendFunc Test");
	...
	nvgText(vg, 10, 20, "nvgGlobalCompositeBlendFunc - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalcompositeblendfunc_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalCompositeBlendFunc variant 1\n");
	return 0;
}
