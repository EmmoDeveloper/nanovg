...
// Test: nvgGlobalCompositeBlendFuncSeparate with parameters: {'srcRGB': 'NVG_ONE', 'dstRGB': 'NVG_ZERO', 'srcAlpha': 'NVG_ONE', 'dstAlpha': 'NVG_ZERO'}

int main(void)
{
	printf("=== Testing nvgGlobalCompositeBlendFuncSeparate variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgGlobalCompositeBlendFuncSeparate Test");
	...
	nvgText(vg, 10, 20, "nvgGlobalCompositeBlendFuncSeparate - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalcompositeblendfuncseparate_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalCompositeBlendFuncSeparate variant 0\n");
	return 0;
}
