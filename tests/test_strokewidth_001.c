...
// Test: nvgStrokeWidth with parameters: {'size': 2.0}

int main(void)
{
	printf("=== Testing nvgStrokeWidth variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgStrokeWidth - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_strokewidth_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgStrokeWidth variant 1\n");
	return 0;
}
