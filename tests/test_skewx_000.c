...
// Test: nvgSkewX with parameters: {'angle': 0.0}

int main(void)
{
	printf("=== Testing nvgSkewX variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgSkewX - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_skewx_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgSkewX variant 0\n");
	return 0;
}
