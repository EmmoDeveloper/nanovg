...
// Test: nvgScissor with parameters: {'x': 50, 'y': 50, 'w': 200, 'h': 150}

int main(void)
{
	printf("=== Testing nvgScissor variant 1 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgScissor Test");
	...
	nvgText(vg, 10, 20, "nvgScissor - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_scissor_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgScissor variant 1\n");
	return 0;
}
