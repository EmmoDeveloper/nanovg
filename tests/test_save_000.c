...
// Test: nvgSave with parameters: {}

int main(void)
{
	printf("=== Testing nvgSave variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgSave Test");
	...
	nvgText(vg, 10, 20, "nvgSave - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_save_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgSave variant 0\n");
	return 0;
}
