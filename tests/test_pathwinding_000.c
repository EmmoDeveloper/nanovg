...
// Test: nvgPathWinding with parameters: {'dir': 'NVG_CCW'}

int main(void)
{
	printf("=== Testing nvgPathWinding variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgPathWinding Test");
	...
	nvgText(vg, 10, 20, "nvgPathWinding - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_pathwinding_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgPathWinding variant 0\n");
	return 0;
}
