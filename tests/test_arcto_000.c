...
// Test: nvgArcTo with parameters: {'x1': 100, 'y1': 200, 'x2': 10, 'y2': 200, 'radius': 10}

int main(void)
{
	printf("=== Testing nvgArcTo variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgArcTo Test");
	...
	nvgText(vg, 10, 20, "nvgArcTo - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_arcto_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgArcTo variant 0\n");
	return 0;
}
