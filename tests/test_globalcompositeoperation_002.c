...
// Test: nvgGlobalCompositeOperation with parameters: {'op': 'NVG_SOURCE_OUT'}

int main(void)
{
	printf("=== Testing nvgGlobalCompositeOperation variant 2 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalCompositeOperation - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalcompositeoperation_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalCompositeOperation variant 2\n");
	return 0;
}
