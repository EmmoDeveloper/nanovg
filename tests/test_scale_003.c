...
// Test: nvgScale with parameters: {'x': 1.0, 'y': 2.0}

int main(void)
{
	printf("=== Testing nvgScale variant 3 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgScale Test");
	...
	nvgText(vg, 10, 20, "nvgScale - variant 3", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_scale_003.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgScale variant 3\n");
	return 0;
}
