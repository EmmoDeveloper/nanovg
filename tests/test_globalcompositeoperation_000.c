...
// Test: nvgGlobalCompositeOperation with parameters: {'op': 'NVG_SOURCE_OVER'}

int main(void)
{
	printf("=== Testing nvgGlobalCompositeOperation variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalCompositeOperation - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalcompositeoperation_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalCompositeOperation variant 0\n");
	return 0;
}
