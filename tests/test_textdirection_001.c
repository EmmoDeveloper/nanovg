...
// Test: nvgTextDirection with parameters: {'direction': 'NVG_TEXT_DIR_LTR'}

int main(void)
{
	printf("=== Testing nvgTextDirection variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgTextDirection - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_textdirection_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTextDirection variant 1\n");
	return 0;
}
