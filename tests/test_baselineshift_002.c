...
// Test: nvgBaselineShift with parameters: {'offset': -5.0}

int main(void)
{
	printf("=== Testing nvgBaselineShift variant 2 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgBaselineShift Test");
	...
	nvgText(vg, 10, 20, "nvgBaselineShift - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_baselineshift_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgBaselineShift variant 2\n");
	return 0;
}
