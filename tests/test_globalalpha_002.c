...
// Test: nvgGlobalAlpha with parameters: {'alpha': 0.5}

int main(void)
{
	printf("=== Testing nvgGlobalAlpha variant 2 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalAlpha - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalalpha_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalAlpha variant 2\n");
	return 0;
}
