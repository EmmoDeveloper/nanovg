...
// Test: nvgFontFeaturesReset with parameters: {}

int main(void)
{
	printf("=== Testing nvgFontFeaturesReset variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgFontFeaturesReset Test");
	...
	nvgText(vg, 10, 20, "nvgFontFeaturesReset - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_fontfeaturesreset_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgFontFeaturesReset variant 0\n");
	return 0;
}
