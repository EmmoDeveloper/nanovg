...
// Test: nvgGlobalAlpha with parameters: {'alpha': 0.25}

int main(void)
{
	printf("=== Testing nvgGlobalAlpha variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalAlpha - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalalpha_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalAlpha variant 1\n");
	return 0;
}
