...
// Test: nvgScale with parameters: {'x': 1.0, 'y': 1.0}

int main(void)
{
	printf("=== Testing nvgScale variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgScale - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_scale_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgScale variant 0\n");
	return 0;
}
