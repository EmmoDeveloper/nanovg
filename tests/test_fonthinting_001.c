...
// Test: nvgFontHinting with parameters: {'hinting': 'NVG_HINTING_LIGHT'}

int main(void)
{
	printf("=== Testing nvgFontHinting variant 1 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgFontHinting Test");
	...
	nvgText(vg, 10, 20, "nvgFontHinting - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_fonthinting_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgFontHinting variant 1\n");
	return 0;
}
