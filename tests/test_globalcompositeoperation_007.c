...
// Test: nvgGlobalCompositeOperation with parameters: {'op': 'NVG_DESTINATION_ATOP'}

int main(void)
{
	printf("=== Testing nvgGlobalCompositeOperation variant 7 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalCompositeOperation - variant 7", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalcompositeoperation_007.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalCompositeOperation variant 7\n");
	return 0;
}
