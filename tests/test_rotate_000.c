...
// Test: nvgRotate with parameters: {'angle': 0.0}

int main(void)
{
	printf("=== Testing nvgRotate variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgRotate - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_rotate_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgRotate variant 0\n");
	return 0;
}
