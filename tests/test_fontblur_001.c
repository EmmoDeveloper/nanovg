...
// Test: nvgFontBlur with parameters: {'blur': 1.0}

int main(void)
{
	printf("=== Testing nvgFontBlur variant 1 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgFontBlur Test");
	...
	nvgText(vg, 10, 20, "nvgFontBlur - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_fontblur_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgFontBlur variant 1\n");
	return 0;
}
