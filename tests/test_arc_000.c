...
// Test: nvgArc with parameters: {'cx': 100, 'cy': 100, 'r': 50, 'a0': 0, 'a1': 3.14, 'dir': 'NVG_CW'}

int main(void)
{
	printf("=== Testing nvgArc variant 0 ===\n");
	...
	nvgBeginPath(vg);
	nvgArc(vg, 100, 100, 50, 0, 3.14f, NVG_CW);
	...
	nvgText(vg, 10, 20, "nvgArc - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_arc_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgArc variant 0\n");
	return 0;
}
