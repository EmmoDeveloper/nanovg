...
// Test: nvgTextAlign with parameters: {'align': 'NVG_ALIGN_LEFT | NVG_ALIGN_TOP'}

int main(void)
{
	printf("=== Testing nvgTextAlign variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgTextAlign - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_textalign_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTextAlign variant 0\n");
	return 0;
}
