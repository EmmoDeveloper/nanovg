...
// Test: nvgKerningEnabled with parameters: {'enabled': 0}

int main(void)
{
	printf("=== Testing nvgKerningEnabled variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgKerningEnabled Test");
	...
	nvgText(vg, 10, 20, "nvgKerningEnabled - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_kerningenabled_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgKerningEnabled variant 0\n");
	return 0;
}
