...
// Test: nvgBaselineShift with parameters: {'offset': 0.0}

int main(void)
{
	printf("=== Testing nvgBaselineShift variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgBaselineShift - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_baselineshift_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgBaselineShift variant 0\n");
	return 0;
}
