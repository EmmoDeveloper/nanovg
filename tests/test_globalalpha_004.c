...
// Test: nvgGlobalAlpha with parameters: {'alpha': 1.0}

int main(void)
{
	printf("=== Testing nvgGlobalAlpha variant 4 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalAlpha - variant 4", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalalpha_004.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalAlpha variant 4\n");
	return 0;
}
