...
// Test: nvgGlobalAlpha with parameters: {'alpha': 0.0}

int main(void)
{
	printf("=== Testing nvgGlobalAlpha variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgGlobalAlpha Test");
	...
	nvgText(vg, 10, 20, "nvgGlobalAlpha - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalalpha_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalAlpha variant 0\n");
	return 0;
}
