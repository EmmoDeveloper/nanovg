...
// Test: nvgGlobalCompositeOperation with parameters: {'op': 'NVG_ATOP'}

int main(void)
{
	printf("=== Testing nvgGlobalCompositeOperation variant 3 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalCompositeOperation - variant 3", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalcompositeoperation_003.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalCompositeOperation variant 3\n");
	return 0;
}
