...
// Test: nvgStrokeWidth with parameters: {'size': 1.0}

int main(void)
{
	printf("=== Testing nvgStrokeWidth variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgStrokeWidth - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_strokewidth_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgStrokeWidth variant 0\n");
	return 0;
}
