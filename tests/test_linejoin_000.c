...
// Test: nvgLineJoin with parameters: {'join': 'NVG_MITER'}

int main(void)
{
	printf("=== Testing nvgLineJoin variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgLineJoin - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_linejoin_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgLineJoin variant 0\n");
	return 0;
}
