...
// Test: nvgBeginPath with parameters: {}

int main(void)
{
	printf("=== Testing nvgBeginPath variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgBeginPath Test");
	...
	nvgText(vg, 10, 20, "nvgBeginPath - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_beginpath_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgBeginPath variant 0\n");
	return 0;
}
