...
int main(void)
{
	...
	printf("Rendering for 3 seconds...\n");
	for (int frame = 0; frame < 180; frame++) {  // Show for 3 seconds at 60fps
		...
		nvgText(vg, 250, 100, "STRESS TEST", NULL);
