...
// Test: nvgResetScissor with parameters: {}

int main(void)
{
	printf("=== Testing nvgResetScissor variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgResetScissor Test");
	...
	nvgText(vg, 10, 20, "nvgResetScissor - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_resetscissor_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgResetScissor variant 0\n");
	return 0;
}
