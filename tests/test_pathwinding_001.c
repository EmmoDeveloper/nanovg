...
// Test: nvgPathWinding with parameters: {'dir': 'NVG_CW'}

int main(void)
{
	printf("=== Testing nvgPathWinding variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgPathWinding - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_pathwinding_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgPathWinding variant 1\n");
	return 0;
}
