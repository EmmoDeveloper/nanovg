...
// Test: nvgTranslate with parameters: {'x': 100, 'y': 50}

int main(void)
{
	printf("=== Testing nvgTranslate variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgTranslate - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_translate_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTranslate variant 1\n");
	return 0;
}
