...
// Test: nvgTranslate with parameters: {'x': 0, 'y': 0}

int main(void)
{
	printf("=== Testing nvgTranslate variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgTranslate - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_translate_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTranslate variant 0\n");
	return 0;
}
