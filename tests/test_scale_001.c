...
// Test: nvgScale with parameters: {'x': 0.5, 'y': 0.5}

int main(void)
{
	printf("=== Testing nvgScale variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgScale - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_scale_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgScale variant 1\n");
	return 0;
}
