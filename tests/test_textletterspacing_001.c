...
// Test: nvgTextLetterSpacing with parameters: {'spacing': 1.0}

int main(void)
{
	printf("=== Testing nvgTextLetterSpacing variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgTextLetterSpacing - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_textletterspacing_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTextLetterSpacing variant 1\n");
	return 0;
}
