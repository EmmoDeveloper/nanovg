...
// Test: nvgStroke with parameters: {}

int main(void)
{
	printf("=== Testing nvgStroke variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgStroke Test");
	...
	nvgText(vg, 10, 20, "nvgStroke - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_stroke_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgStroke variant 0\n");
	return 0;
}
