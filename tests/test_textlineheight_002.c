...
// Test: nvgTextLineHeight with parameters: {'lineHeight': 2.0}

int main(void)
{
	printf("=== Testing nvgTextLineHeight variant 2 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgTextLineHeight Test");
	...
	nvgText(vg, 10, 20, "nvgTextLineHeight - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_textlineheight_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTextLineHeight variant 2\n");
	return 0;
}
