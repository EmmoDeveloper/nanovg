...
// Test: nvgGlobalCompositeOperation with parameters: {'op': 'NVG_DESTINATION_IN'}

int main(void)
{
	printf("=== Testing nvgGlobalCompositeOperation variant 5 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalCompositeOperation - variant 5", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalcompositeoperation_005.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalCompositeOperation variant 5\n");
	return 0;
}
