...
// Test: nvgKerningEnabled with parameters: {'enabled': 1}

int main(void)
{
	printf("=== Testing nvgKerningEnabled variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgKerningEnabled - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_kerningenabled_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgKerningEnabled variant 1\n");
	return 0;
}
