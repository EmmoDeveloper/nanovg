...
// Test: nvgGlobalCompositeOperation with parameters: {'op': 'NVG_XOR'}

int main(void)
{
	printf("=== Testing nvgGlobalCompositeOperation variant 10 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalCompositeOperation - variant 10", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalcompositeoperation_010.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalCompositeOperation variant 10\n");
	return 0;
}
