...
// Test: nvgLineTo with parameters: {'x': 10, 'y': 100}

int main(void)
{
	printf("=== Testing nvgLineTo variant 1 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgLineTo Test");
	...
	nvgText(vg, 10, 20, "nvgLineTo - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_lineto_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgLineTo variant 1\n");
	return 0;
}
