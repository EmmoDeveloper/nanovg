...
// Test: nvgEllipse with parameters: {'cx': 400, 'cy': 100, 'rx': 30, 'ry': 50}

int main(void)
{
	printf("=== Testing nvgEllipse variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgEllipse - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_ellipse_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgEllipse variant 1\n");
	return 0;
}
