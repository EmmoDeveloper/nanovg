...
// Test: nvgTextDirection with parameters: {'direction': 'NVG_TEXT_DIR_AUTO'}

int main(void)
{
	printf("=== Testing nvgTextDirection variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgTextDirection - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_textdirection_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTextDirection variant 0\n");
	return 0;
}
