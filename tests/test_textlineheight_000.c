...
// Test: nvgTextLineHeight with parameters: {'lineHeight': 1.0}

int main(void)
{
	printf("=== Testing nvgTextLineHeight variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgTextLineHeight - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_textlineheight_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTextLineHeight variant 0\n");
	return 0;
}
