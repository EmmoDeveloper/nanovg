...
// Test: nvgTranslate with parameters: {'x': -50, 'y': 100}

int main(void)
{
	printf("=== Testing nvgTranslate variant 2 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgTranslate Test");
	...
	nvgText(vg, 10, 20, "nvgTranslate - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_translate_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTranslate variant 2\n");
	return 0;
}
