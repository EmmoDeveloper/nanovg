...
// Test: nvgCircle with parameters: {'cx': 500, 'cy': 100, 'r': 40}

int main(void)
{
	printf("=== Testing nvgCircle variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgCircle - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_circle_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgCircle variant 0\n");
	return 0;
}
