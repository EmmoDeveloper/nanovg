...
// Test: nvgMoveTo with parameters: {'x': 10, 'y': 10}

int main(void)
{
	printf("=== Testing nvgMoveTo variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgMoveTo - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_moveto_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgMoveTo variant 0\n");
	return 0;
}
