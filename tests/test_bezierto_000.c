...
// Test: nvgBezierTo with parameters: {'c1x': 50, 'c1y': 10, 'c2x': 100, 'c2y': 50, 'x': 100, 'y': 100}

int main(void)
{
	printf("=== Testing nvgBezierTo variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgBezierTo Test");
	...
	nvgBezierTo(vg, 50, 10, 100, 50, 100, 100);
	...
	nvgText(vg, 10, 20, "nvgBezierTo - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_bezierto_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgBezierTo variant 0\n");
	return 0;
}
