...
// Test: nvgBeginFrame with parameters: {'width': 800, 'height': 600, 'ratio': 1.0}

int main(void)
{
	printf("=== Testing nvgBeginFrame variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgBeginFrame - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_beginframe_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgBeginFrame variant 0\n");
	return 0;
}
