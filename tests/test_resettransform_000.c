...
// Test: nvgResetTransform with parameters: {}

int main(void)
{
	printf("=== Testing nvgResetTransform variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgResetTransform Test");
	...
	nvgText(vg, 10, 20, "nvgResetTransform - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_resettransform_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgResetTransform variant 0\n");
	return 0;
}
