...
// Test: nvgTextLetterSpacing with parameters: {'spacing': -0.5}

int main(void)
{
	printf("=== Testing nvgTextLetterSpacing variant 2 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgTextLetterSpacing Test");
	...
	nvgText(vg, 10, 20, "nvgTextLetterSpacing - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_textletterspacing_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTextLetterSpacing variant 2\n");
	return 0;
}
