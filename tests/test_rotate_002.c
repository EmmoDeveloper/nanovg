...
// Test: nvgRotate with parameters: {'angle': 1.57}

int main(void)
{
	printf("=== Testing nvgRotate variant 2 ===\n");
	...
	nvgText(vg, 10, 20, "nvgRotate - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_rotate_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgRotate variant 2\n");
	return 0;
}
