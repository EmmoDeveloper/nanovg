...
// Test: nvgGlobalCompositeOperation with parameters: {'op': 'NVG_DESTINATION_OUT'}

int main(void)
{
	printf("=== Testing nvgGlobalCompositeOperation variant 6 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalCompositeOperation - variant 6", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalcompositeoperation_006.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalCompositeOperation variant 6\n");
	return 0;
}
