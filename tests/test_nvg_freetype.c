...
int main(void)
{
	printf("=== NanoVG FreeType Text Test ===\n\n");
	...
	printf("6. Drawing with NanoVG...\n");
	nvgBeginFrame(vg, 800, 600, 1.0f);

	nvgFontSize(vg, 48.0f);
	nvgFontFace(vg, "sans");
	nvgFillColor(vg, nvgRGBA(255, 255, 255, 255));
	nvgText(vg, 100.0f, 300.0f, "Hello FreeType!", NULL);
	...
	printf("=== FreeType Text Test PASSED ===\n");
	return 0;
}
