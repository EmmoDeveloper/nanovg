...
// Test: nvgGlobalCompositeOperation with parameters: {'op': 'NVG_COPY'}

int main(void)
{
	printf("=== Testing nvgGlobalCompositeOperation variant 9 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalCompositeOperation - variant 9", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalcompositeoperation_009.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalCompositeOperation variant 9\n");
	return 0;
}
