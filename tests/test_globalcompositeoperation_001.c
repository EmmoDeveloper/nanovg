...
// Test: nvgGlobalCompositeOperation with parameters: {'op': 'NVG_SOURCE_IN'}

int main(void)
{
	printf("=== Testing nvgGlobalCompositeOperation variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalCompositeOperation - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalcompositeoperation_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalCompositeOperation variant 1\n");
	return 0;
}
