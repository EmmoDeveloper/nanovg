...
// Test: nvgTextLetterSpacing with parameters: {'spacing': 0.0}

int main(void)
{
	printf("=== Testing nvgTextLetterSpacing variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgTextLetterSpacing - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_textletterspacing_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTextLetterSpacing variant 0\n");
	return 0;
}
