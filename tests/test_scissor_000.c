...
// Test: nvgScissor with parameters: {'x': 0, 'y': 0, 'w': 100, 'h': 100}

int main(void)
{
	printf("=== Testing nvgScissor variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgScissor - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_scissor_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgScissor variant 0\n");
	return 0;
}
