...
// Test: nvgMiterLimit with parameters: {'limit': 4.0}

int main(void)
{
	printf("=== Testing nvgMiterLimit variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgMiterLimit - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_miterlimit_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgMiterLimit variant 0\n");
	return 0;
}
