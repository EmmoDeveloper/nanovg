...
int main(void)
{
	printf("=== Testing nvgBaselineShift variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgBaselineShift - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_baselineshift_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgBaselineShift variant 1\n");
	return 0;
}
