...
// Test: nvgShapeAntiAlias with parameters: {'enabled': 1}

int main(void)
{
	printf("=== Testing nvgShapeAntiAlias variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgShapeAntiAlias - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_shapeantialias_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgShapeAntiAlias variant 1\n");
	return 0;
}
