...
// Test: nvgSkewY with parameters: {'angle': 0.1}

int main(void)
{
	printf("=== Testing nvgSkewY variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgSkewY - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_skewy_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgSkewY variant 1\n");
	return 0;
}
