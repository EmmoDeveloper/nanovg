...
// Test: nvgGlobalAlpha with parameters: {'alpha': 0.75}

int main(void)
{
	printf("=== Testing nvgGlobalAlpha variant 3 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalAlpha - variant 3", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalalpha_003.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalAlpha variant 3\n");
	return 0;
}
