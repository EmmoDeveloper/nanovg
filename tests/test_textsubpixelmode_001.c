...
// Test: nvgTextSubpixelMode with parameters: {'mode': 1}

int main(void)
{
	printf("=== Testing nvgTextSubpixelMode variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgTextSubpixelMode - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_textsubpixelmode_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTextSubpixelMode variant 1\n");
	return 0;
}
