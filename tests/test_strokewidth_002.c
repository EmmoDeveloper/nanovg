...
// Test: nvgStrokeWidth with parameters: {'size': 5.0}

int main(void)
{
	printf("=== Testing nvgStrokeWidth variant 2 ===\n");
	...
	nvgText(vg, 10, 20, "nvgStrokeWidth - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_strokewidth_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgStrokeWidth variant 2\n");
	return 0;
}
