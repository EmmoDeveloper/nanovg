...
// Test: nvgLineJoin with parameters: {'join': 'NVG_BEVEL'}

int main(void)
{
	printf("=== Testing nvgLineJoin variant 2 ===\n");
	...
	nvgText(vg, 10, 20, "nvgLineJoin - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_linejoin_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgLineJoin variant 2\n");
	return 0;
}
