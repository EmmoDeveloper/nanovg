...
// Test: nvgGlobalCompositeOperation with parameters: {'op': 'NVG_LIGHTER'}

int main(void)
{
	printf("=== Testing nvgGlobalCompositeOperation variant 8 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalCompositeOperation - variant 8", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalcompositeoperation_008.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalCompositeOperation variant 8\n");
	return 0;
}
