...
// Test: nvgRoundedRect with parameters: {'x': 10, 'y': 100, 'w': 100, 'h': 50, 'r': 5}

int main(void)
{
	printf("=== Testing nvgRoundedRect variant 0 ===\n");
	...
	nvgBeginPath(vg);
	nvgRoundedRect(vg, 10, 100, 100, 50, 5);
	...
	nvgText(vg, 10, 20, "nvgRoundedRect - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_roundedrect_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgRoundedRect variant 0\n");
	return 0;
}
