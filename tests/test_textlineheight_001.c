...
// Test: nvgTextLineHeight with parameters: {'lineHeight': 1.5}

int main(void)
{
	printf("=== Testing nvgTextLineHeight variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgTextLineHeight - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_textlineheight_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTextLineHeight variant 1\n");
	return 0;
}
