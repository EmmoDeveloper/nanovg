...
// Test: nvgQuadTo with parameters: {'cx': 150, 'cy': 10, 'x': 200, 'y': 100}

int main(void)
{
	printf("=== Testing nvgQuadTo variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgQuadTo Test");
	...
	nvgText(vg, 10, 20, "nvgQuadTo - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_quadto_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgQuadTo variant 0\n");
	return 0;
}
