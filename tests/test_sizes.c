...
int main(void) {
	printf("=== Multiple Font Sizes Test ===\n");

	WindowVulkanContext* winCtx = window_create_context(1200, 900, "Font Sizes");
	if (!winCtx) return 1;
	...
	if (window_save_screenshot(winCtx, imageIndex, "screendumps/sizes_test.ppm")) {
