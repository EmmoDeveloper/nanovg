...
// Test: nvgFontSize with parameters: {'size': 18.0}

int main(void)
{
	printf("=== Testing nvgFontSize variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgFontSize - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_fontsize_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgFontSize variant 1\n");
	return 0;
}
