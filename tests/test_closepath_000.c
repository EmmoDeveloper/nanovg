...
// Test: nvgClosePath with parameters: {}

int main(void)
{
	printf("=== Testing nvgClosePath variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgClosePath Test");
	...
	nvgText(vg, 10, 20, "nvgClosePath - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_closepath_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgClosePath variant 0\n");
	return 0;
}
