...
// Test: nvgFill with parameters: {}

int main(void)
{
	printf("=== Testing nvgFill variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgFill Test");
	...
	nvgText(vg, 10, 20, "nvgFill - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_fill_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgFill variant 0\n");
	return 0;
}
