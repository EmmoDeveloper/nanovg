...
// Test: nvgTextAlign with parameters: {'align': 'NVG_ALIGN_RIGHT | NVG_ALIGN_BOTTOM'}

int main(void)
{
	printf("=== Testing nvgTextAlign variant 2 ===\n");
	...
	nvgText(vg, 10, 20, "nvgTextAlign - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_textalign_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgTextAlign variant 2\n");
	return 0;
}
