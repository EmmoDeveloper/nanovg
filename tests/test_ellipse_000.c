...
// Test: nvgEllipse with parameters: {'cx': 300, 'cy': 100, 'rx': 50, 'ry': 30}

int main(void)
{
	printf("=== Testing nvgEllipse variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgEllipse Test");
	...
	nvgText(vg, 10, 20, "nvgEllipse - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_ellipse_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgEllipse variant 0\n");
	return 0;
}
