...
// Test: nvgLineCap with parameters: {'cap': 'NVG_ROUND'}

int main(void)
{
	printf("=== Testing nvgLineCap variant 1 ===\n");
	...
	nvgText(vg, 10, 20, "nvgLineCap - variant 1", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_linecap_001.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgLineCap variant 1\n");
	return 0;
}
