...
// Test: nvgLineCap with parameters: {'cap': 'NVG_SQUARE'}

int main(void)
{
	printf("=== Testing nvgLineCap variant 2 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgLineCap Test");
	...
	nvgText(vg, 10, 20, "nvgLineCap - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_linecap_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgLineCap variant 2\n");
	return 0;
}
