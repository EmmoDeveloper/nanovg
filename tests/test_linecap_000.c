...
// Test: nvgLineCap with parameters: {'cap': 'NVG_BUTT'}

int main(void)
{
	printf("=== Testing nvgLineCap variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgLineCap - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_linecap_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgLineCap variant 0\n");
	return 0;
}
