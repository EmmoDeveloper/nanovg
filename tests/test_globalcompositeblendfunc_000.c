...
// Test: nvgGlobalCompositeBlendFunc with parameters: {'sfactor': 'NVG_ONE', 'dfactor': 'NVG_ZERO'}

int main(void)
{
	printf("=== Testing nvgGlobalCompositeBlendFunc variant 0 ===\n");
	...
	nvgText(vg, 10, 20, "nvgGlobalCompositeBlendFunc - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_globalcompositeblendfunc_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgGlobalCompositeBlendFunc variant 0\n");
	return 0;
}
