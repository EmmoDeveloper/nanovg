...
// Test: nvgShapeAntiAlias with parameters: {'enabled': 0}

int main(void)
{
	printf("=== Testing nvgShapeAntiAlias variant 0 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgShapeAntiAlias Test");
	...
	nvgText(vg, 10, 20, "nvgShapeAntiAlias - variant 0", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_shapeantialias_000.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgShapeAntiAlias variant 0\n");
	return 0;
}
