...
// Test: nvgBeginFrame with parameters: {'width': 400, 'height': 300, 'ratio': 0.5}

int main(void)
{
	printf("=== Testing nvgBeginFrame variant 2 ===\n");
	...
	nvgText(vg, 10, 20, "nvgBeginFrame - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_beginframe_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgBeginFrame variant 2\n");
	return 0;
}
