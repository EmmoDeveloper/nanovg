...
// Test: nvgSkewY with parameters: {'angle': 0.5}

int main(void)
{
	printf("=== Testing nvgSkewY variant 2 ===\n");

	WindowVulkanContext* winCtx = window_create_context(800, 600, "nvgSkewY Test");
	...
	nvgText(vg, 10, 20, "nvgSkewY - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_skewy_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgSkewY variant 2\n");
	return 0;
}
