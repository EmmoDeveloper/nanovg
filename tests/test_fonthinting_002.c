...
// Test: nvgFontHinting with parameters: {'hinting': 'NVG_HINTING_FULL'}

int main(void)
{
	printf("=== Testing nvgFontHinting variant 2 ===\n");
	...
	nvgText(vg, 10, 20, "nvgFontHinting - variant 2", NULL);
	...
	window_save_screenshot(winCtx, imageIndex, "screendumps/test_fonthinting_002.ppm");

	nvgDeleteVk(vg);
	window_destroy_context(winCtx);

	printf("Test PASSED: nvgFontHinting variant 2\n");
	return 0;
}
