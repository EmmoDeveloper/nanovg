...
static void vknvg__initAtlasPacker(VKNVGatlasPacker* packer,
                                   uint16_t width,
                                   uint16_t height)
{
	if (!packer) return;
...
static int vknvg__packRect(VKNVGatlasPacker* packer,
                           uint16_t width,
                           uint16_t height,
                           VKNVGrect* outRect,
                           VKNVGpackingHeuristic heuristic,
...
static float vknvg__getPackingEfficiency(const VKNVGatlasPacker* packer)
{
...
static void vknvg__resetAtlasPacker(VKNVGatlasPacker* packer)
{
	if (!packer) return;
